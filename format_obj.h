...
typedef struct Format_Mtl_Material {
    ...
    bool was_set_ambient_color;                     
    bool was_set_diffuse_color;                     
    bool was_set_specular_color;                    
    bool was_set_emissive_color;                    
    bool was_set_specular_exponent;                  
    bool was_set_opacity;                            
    bool was_set_illumination_mode;                  

    bool was_set_pbr_roughness;                           
    bool was_set_pbr_metallic;                            
    bool was_set_pbr_sheen;                               
    bool was_set_pbr_anisotropy;                          
    bool was_set_pbr_anisotropy_rotation;                 
    bool was_set_pbr_clearcoat_thickness;                 
    bool was_set_pbr_clearcoat_roughness;                 

    bool was_set_only_for_transparent_transmission_filter_color;    
    bool was_set_only_for_transparent_optical_density;               
        ...
        for(Line_Iterator it = {0}; line_iterator_get_line(&it, mtl_source); )
        {
            PROFILE_SCOPE(line) 
            {
                ...
                else
                {
                    ...
                    for(isize k = 0; k < ARRAY_LEN(map_table); k++)
                    {
